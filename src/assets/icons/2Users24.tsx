...
const TwoUsers24 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M18.16 13.268a.75.75 0 0 0-.32 1.465c.792.174 1.425.472 1.843.814.419.342.567.677.567.953 0 .25-.12.545-.453.854-.335.311-.85.599-1.513.799a.75.75 0 1 0 .432 1.436c.823-.248 1.558-.631 2.102-1.136.546-.507.932-1.174.932-1.953 0-.865-.474-1.588-1.117-2.114-.643-.526-1.51-.907-2.472-1.118Z"
    />
  </svg>
);
export { TwoUsers24 };

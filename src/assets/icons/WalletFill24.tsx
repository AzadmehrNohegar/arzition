...
const WalletFill24 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M21.1 8.004C21.045 8 20.983 8 20.92 8h-2.525c-2.068 0-3.837 1.628-3.837 3.75s1.77 3.75 3.837 3.75h2.525c.063 0 .125 0 .182-.004a1.755 1.755 0 0 0 1.645-1.628c.004-.06.004-.125.004-.185V9.817c0-.06 0-.125-.004-.185A1.755 1.755 0 0 0 21.1 8.004Zm-2.928 4.746c.532 0 .963-.448.963-1s-.431-1-.963-1c-.533 0-.964.448-.964 1s.431 1 .964 1Z"
      clipRule="evenodd"
    />
    <path
      fill="currentColor"
